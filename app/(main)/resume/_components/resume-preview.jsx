                    ...
                    <section>
                        ...
                        <div className="flex flex-wrap gap-2">
                            {data.skills?.split(",").map((s, i) => (
                                <span key={i} className="bg-slate-800 text-white px-2 py-1 text-[10px] font-bold rounded uppercase tracking-widest">{s.trim()}</span>
                            ))}
                        </div>
                    </section>
                ...
                <div className="grid grid-cols-2 gap-10">
                    ...
                    <section>
                        ...
                        <div className="flex flex-wrap gap-x-4 gap-y-2">
                            {data.skills?.split(",").map((s, i) => (
                                <span key={i} className="text-[10px] font-black uppercase tracking-wider">{s.trim()}</span>
                            ))}
                        </div>
                    </section>
                </div>
    ...
    return (
        <div className="p-0 bg-white text-gray-800 min-h-screen font-sans flex flex-col">
            ...
            <div className="flex-1 flex overflow-hidden">
                {/* Sidebar */}
                <div className="w-1/3 bg-gray-50 p-8 space-y-8 border-r border-gray-100 uppercase tracking-wider text-[10px] font-bold text-gray-400">
                    <section>
                        <h2 className="text-purple-600 mb-4 border-b pb-1">Contact</h2>
                        <div className="space-y-3 text-gray-600 normal-case font-medium text-xs tracking-normal">
                    ...
                    <section>
                        ...
                        <div className="flex flex-wrap gap-2 normal-case tracking-normal">
                            {data.skills?.split(",").map((s, i) => (
                                <span key={i} className="bg-white border px-2 py-1 rounded text-xs text-gray-700">{s.trim()}</span>
                            ))}
                        </div>
                    </section>
                ...
                <div className="flex-1 p-8 space-y-10">
                    ...
                    <section>
                        ...
                        <div className="space-y-8 border-l-2 border-gray-100 ml-1 pl-6">
                            {data.experience?.map((exp, i) => (
                                <div key={i} className="relative">
                                    <div className="absolute left-[-31px] top-[6px] w-4 h-4 rounded-full bg-white border-2 border-purple-600" />
...
export const ResumePreview = () => {
    const { resumeData, template, zoom } = useResume();

    return (
        <div className="flex justify-center w-full min-h-full py-12 px-8">
            <div
                id="resume-content"
                className="w-[210mm] bg-white shadow-[0_25px_80px_rgba(0,0,0,0.6)] origin-top transition-all duration-300 ease-out rounded-sm ring-1 ring-black/5"
                style={{
                    transform: `scale(${zoom / 100})`,
                    marginBottom: `calc(100vh - ${zoom}% + 100px)`,
                }}
            >
