    ...
    return (
        <html lang="en" className="dark">
            <body className={`${inter.className} bg-background text-foreground antialiased min-h-screen flex flex-col items-center justify-center p-4`}>
                <div className="max-w-md w-full text-center gap-y-">
                    <div className="mx-auto size- bg-red-500/10 rounded-full flex items-center justify-center">
                        <AlertCircle className="size- text-red-500" />
                    </div>
                    ...
                    <div className="flex flex-col sm:flex-row gap-4 justify-center mt-6">
                        <Button type="button" onClick={() => reset()} variant="default" className="w-full sm:w-auto">
                            Try again
                        </Button>
