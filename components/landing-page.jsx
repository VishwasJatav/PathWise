          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 max-w-4xl mx-auto text-center">
            {[
              ...
              <AnimatedSection key={stat.label} delay={index * 0.1}>
                <div className="flex flex-col items-center justify-center gap-y- p-6 rounded-xl bg-background shadow-sm hover:shadow-lg hover:scale-105 transition-all duration-300">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 max-w-6xl mx-auto">
            {howItWorks.map((item, index) => (
              <AnimatedSection key={item.title} delay={index * 0.15}>
                <div className="flex flex-col items-center text-center gap-y-">
                  <div className="size- rounded-full bg-primary/10 flex items-center justify-center ring-1 ring-primary/20 transition-all duration-300 hover:ring-primary/60 hover:bg-primary/20 hover:scale-110">
                    {item.icon}
                  </div>
      ...
      <section className="w-full">
        <AnimatedSection>
          <div className="mx-auto py-24 gradient rounded-lg">
            <div className="flex flex-col items-center justify-center gap-y- text-center max-w-3xl mx-auto">
              ...
              <Link href="/dashboard" passHref>
                ...
                >
                  ...
                  <ArrowRight className="ml-2 size-" />
                </Button>
              </Link>
            </div>
          </div>
